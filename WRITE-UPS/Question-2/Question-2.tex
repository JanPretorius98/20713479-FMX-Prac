...
\midrule
Semi Deviation & $2.11\%$ & $2.14\%$ \\ 
Downside Deviation (Rf=0\%) & $1.72\%$ & $1.76\%$ \\ 
Maximum Drawdown & $24.96\%$ & $26.01\%$ \\ 
Historical VaR (95\%) & $-3.99\%$ & $-4.22\%$ \\ 
Historical ES (95\%) & $-5.88\%$ & $-6.04\%$ \\ 
Modified VaR (95\%) & $-4.12\%$ & $-4.22\%$ \\ 
Modified ES (95\%) & $-6.74\%$ & $-7.04\%$ \\ 
\bottomrule
\end{longtable}
